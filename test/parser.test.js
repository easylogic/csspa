...
test("create css linear-gradient timing test - ease", () => {
    ...
    expect(result).toEqual({
        ...
        "parameters": [
            "-0.7791965086794089% 40.30037452797422% 80.05772932007076% 40.021450975161% pad",
            "#45abd6 0%",
            "rgb(14,71,119) 48.98766411675347% steps(3, start)",
            "rgb(137,111,133) 72.67366131157286% steps(10, start)",
            "#f69292 99.06577580909027% ease 15"
        ],
        "parsedParameters": [
            [
                {
