...
test("parse radial-gradient", () => {
    const target = 'radial-gradient(rgba(255, 255, 255, 0.1), white 20%)'
    const result = radialGradient({ parseValue, item: {
        startIndex: 0,
    ...
    expect(result).toEqual({
        ...
        "startIndex": 0,
        "endIndex": 52,
        "matchedString": "radial-gradient(rgba(255, 255, 255, 0.1), white 20%)",
